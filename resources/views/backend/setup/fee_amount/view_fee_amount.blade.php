                                    ...
                                    <tbody class="text-align-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('fee.amount.details', $amount->fee_category_id) }}" class="btn btn-primary">Rincian</a>
                                                <a href="{{ route('fee.amount.delete', $amount->fee_category_id) }}" class="btn btn-danger" id="delete">Hapus</a>
                                            </td>
